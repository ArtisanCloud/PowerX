...
func newWeWorkUseCase(conf *config.Config, db *gorm.DB, employee *EmployeeUseCase, department *DepartmentUseCase, auth *AuthUseCase, tag *TagUseCase) *WeWorkUseCase {
	// 初始化企业微信API SDK
