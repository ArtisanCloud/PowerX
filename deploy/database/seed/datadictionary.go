	...
	return &model.DataDictionaryType{
		Items: []*model.DataDictionaryItem{
			&model.DataDictionaryItem{
				...
				Name:  "草稿",
				Value: model.ApprovalStatusDraft,
				Sort:  0,
			},
			&model.DataDictionaryItem{
				...
				Type:  model.TypeProductType,
				Name:  "激活",
				Value: model.ApprovalStatusActive,
				Sort:  0,
			},
			&model.DataDictionaryItem{
				...
				Type:  model.TypeProductType,
				Name:  "取消",
				Value: model.ApprovalStatusCanceled,
				Sort:  0,
			},
			&model.DataDictionaryItem{
				...
				Type:  model.TypeProductType,
				Name:  "代办",
				Value: model.ApprovalStatusPending,
				Sort:  0,
			},
			&model.DataDictionaryItem{
				...
				Type:  model.TypeProductType,
				Name:  "无效",
				Value: model.ApprovalStatusInactive,
				Sort:  0,
			},
		},
