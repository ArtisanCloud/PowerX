...
export class ApiEndpoints {
  ...
  static readonly ADMIN_AGENTS = {
    ...
    CONTEXT_OPTIMIZER_ACTIVE: `${API_CONFIG.ADMIN_AGENTS}/settings/context-optimizer/active`,
    CONTEXT_OPTIMIZER_DRAFTS: `${API_CONFIG.ADMIN_AGENTS}/settings/context-optimizer/drafts`,
    CONTEXT_OPTIMIZER_VERSIONS: `${API_CONFIG.ADMIN_AGENTS}/settings/context-optimizer/versions`,
    CONTEXT_OPTIMIZER_PUBLISH: `${API_CONFIG.ADMIN_AGENTS}/settings/context-optimizer/publish`,
    CONTEXT_OPTIMIZER_ROLLBACK: `${API_CONFIG.ADMIN_AGENTS}/settings/context-optimizer/rollback`,
