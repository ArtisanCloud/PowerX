...
- 默认模块集合（见 `docs/guides/knowledge_space/scenary/MAP_scene_bundle_rag_profiles.md`）：`A_simple`, `L_feedback`
...
- 建议先按 `docs/guides/knowledge_space/scenary/SCN-001_basic_ingestion_and_playground.md` 跑通端到端。
