...
2. 第一层选择「场景」：`SOP/制度/产品说明`
3. 第二层选择「策略包」：`P1 通用推荐`
4. 导入 1 份小样本文档（Word/Markdown，建议 3–10 页或 1k–10k 字）
5. 运行 Corpus Check（如 UI 有推荐卡片，优先一键应用推荐）
6. 进入 Playground：用 3 个问题覆盖 “步骤/定义/边界条件”
