...
- [X] T015B [US3] 动态注册：新增 ws-bus/grant 接口，支持幂等注册 `backend/internal/transport/http/admin/runtime/ws_bus_handler.go`, `backend/internal/transport/http/admin/runtime/routes.go`
