...
type FeedbackCase struct {
	...
	IssueType       string         `gorm:"column:issue_type;type:varchar(32);not null;default:'accuracy'" json:"issue_type"`
	...
	QualityScore    float64        `gorm:"column:quality_score;type:numeric(5,2);not null;default:0" json:"quality_score"`
