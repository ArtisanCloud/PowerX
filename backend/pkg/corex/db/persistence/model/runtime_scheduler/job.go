...
type SchedulerJob struct {
	...
	ActorUserID     uint64         `gorm:"column:actor_user_id;index:idx_scheduler_jobs_actor_user" json:"actor_user_id,omitempty"`
	ActorUserUUID   string         `gorm:"column:actor_user_uuid;type:varchar(64)" json:"actor_user_uuid,omitempty"`
	ActorMemberID   uint64         `gorm:"column:actor_member_id;index:idx_scheduler_jobs_actor_member" json:"actor_member_id,omitempty"`
