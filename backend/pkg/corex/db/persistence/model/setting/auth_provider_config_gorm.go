...
type AuthProviderConfig struct {
	...
	TenantUUID string `gorm:"column:tenant_uuid;type:char(36);not null;index:idx_authp_tenant_uuid_type,priority:1;uniqueIndex:uk_authp_tenant_uuid_type,priority:1" json:"tenant_uuid"`

	Type    string         `gorm:"column:type;type:varchar(32);not null;index:idx_authp_tenant_uuid_type,priority:2;uniqueIndex:uk_authp_tenant_uuid_type,priority:2" json:"type"` // builtin|oidc|saml|ldap|wechat
