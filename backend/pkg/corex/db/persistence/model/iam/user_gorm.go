...
type User struct {
	...
	LastTenantUUID string `gorm:"column:last_tenant_uuid;type:char(36);index" json:"last_tenant_uuid,omitempty"`
	IsRoot         bool   `gorm:"column:is_root;type:boolean;default:false;index" json:"is_root"`
}
...
func (mdl *User) ToLite() map[string]any {
	return map[string]any{
		...
		"last_tenant_uuid": mdl.LastTenantUUID,
		"meta":             mdl.Meta,
	}
}
