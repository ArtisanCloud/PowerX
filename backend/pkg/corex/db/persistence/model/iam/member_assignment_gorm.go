...
type MemberAssignment struct {
	...
	TenantUUID string        `gorm:"column:tenant_uuid;type:char(36);not null;index"`
	...
	// gorm: uniqueIndex:uk_member_assignment,composite:(tenant_uuid,member_id,dim_type,dim_id)
}
