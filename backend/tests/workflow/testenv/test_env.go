...
const (
	ContractTenantUUID = "0c60d880-6f9a-4e48-947c-6b2af9502bd7"
)
...
func bootstrapSchema(db *gorm.DB) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS main.workflow_human_review_tasks (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            uuid TEXT UNIQUE,
            tenant_uuid TEXT NOT NULL,
            ...
            payload TEXT,
            approver_policy TEXT,
            status TEXT NOT NULL DEFAULT 'pending',
            reviewer_user_uuid TEXT,
            decision TEXT,
		...
		`CREATE TABLE IF NOT EXISTS main.workflow_pack_seed_records (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            uuid TEXT UNIQUE,
            tenant_uuid TEXT,
