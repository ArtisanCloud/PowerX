...
func TestAdminHTTPRegisterAndActivate(t *testing.T) {
	...
	req.Header.Set("tenant-uuid", "tenant-001")
	...
	getReq.Header.Set("tenant-uuid", "tenant-001")
	...
	actReq.Header.Set("tenant-uuid", "tenant-001")
	...
	pauseReq.Header.Set("tenant-uuid", "tenant-001")
	...
	resumeReq.Header.Set("tenant-uuid", "tenant-001")
	...
	scaleReq.Header.Set("tenant-uuid", "tenant-001")
	...
	retireReq.Header.Set("tenant-uuid", "tenant-001")
