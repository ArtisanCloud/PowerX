...
func TestAdminHTTPRegisterAndActivate(t *testing.T) {
	...
	actReq.Header.Set("X-PowerX-Tenant", "tenant-001")
	...
	pauseReq.Header.Set("X-PowerX-Tenant", "tenant-001")
	...
	resumeReq.Header.Set("X-PowerX-Tenant", "tenant-001")
	...
	scaleReq.Header.Set("X-PowerX-Tenant", "tenant-001")
	...
	retireReq.Header.Set("X-PowerX-Tenant", "tenant-001")
