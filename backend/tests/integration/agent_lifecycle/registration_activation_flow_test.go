...
func TestRegistrationActivationFlow(t *testing.T) {
	...
	actReq.Header.Set("tenant-uuid", tenantUUID)
	...
	pauseReq.Header.Set("tenant-uuid", tenantUUID)
	...
	resumeReq.Header.Set("tenant-uuid", tenantUUID)
	...
	scaleReq.Header.Set("tenant-uuid", tenantUUID)
	...
	retireReq.Header.Set("tenant-uuid", tenantUUID)
